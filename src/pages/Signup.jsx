      ...
      <div className='bg-[#0A256D] rounded-md md:p-10 py-8 px-3  w-full'>
         ...
         <form onSubmit={handleSubmit} className='mb-10'>
            <div className='flex flex-col mb-5'>
               <label htmlFor="username" className='text-white mb-2 text-[1.1rem] font-semibold'>Name</label>
               <input type="text" id='username' placeholder='Your Name' name='username'  className='border-none rounded-md bg-[#00103B] text-white px-4' 
                  value={formData.username}
                  onChange={handleChange}
               />
            {/* username error */}
            {errors &&  <span className='text-red-700 text-sm '>{errors.username}</span> }
            </div>
            <div className='flex flex-col  mb-5'>
               <label htmlFor="email" className='text-white mb-2 text-[1.1rem] font-semibold'>Email</label>
               <input type="email" id='email' placeholder='user@gmail.com' name='email' className='border-none rounded-md bg-[#00103B] text-white px-4' 
